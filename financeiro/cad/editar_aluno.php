...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Validações básicas (apenas para CPF se preenchido)
        if (!empty($dados['cpf'])) {
        ...
        foreach ($dados as $campo => $valor) {
            $campos[] = "$campo = ?";
            $valores[] = $valor; // Incluir todos os valores, mesmo os vazios
        }
        $valores[] = $aluno_id;
...
<body>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="telefone1" class="form-control" 
                                   placeholder="(00) 00000-0000" value="<?= htmlspecialchars($aluno['telefone1'] ?? '') ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="telefone2" class="form-control" 
                                   placeholder="(00) 00000-0000" value="<?= htmlspecialchars($aluno['telefone2'] ?? '') ?>">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="nome_resp_legal" class="form-control"
                                   value="<?= htmlspecialchars($aluno['nome_resp_legal'] ?? '') ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="cpf_resp_legal" class="form-control" maxlength="14"
                                   value="<?= htmlspecialchars($aluno['cpf_resp_legal'] ?? '') ?>">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="profissao_resp_legal" class="form-control"
                                   value="<?= htmlspecialchars($aluno['profissao_resp_legal'] ?? '') ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="grau_parentesco_resp_legal" class="form-control"
                                   value="<?= htmlspecialchars($aluno['grau_parentesco_resp_legal'] ?? '') ?>">
                          </div>
                        </div>
                      </div>

                      <div class="form-group">
                        <label>Local de trabalho do responsável</label>
                        <input type="text" name="local_trabalho_resp_legal" class="form-control"
                               value="<?= htmlspecialchars($aluno['local_trabalho_resp_legal'] ?? '') ?>">
                      </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const telefoneFields = document.querySelectorAll('input[name="telefone1"], input[name="telefone2"]');
