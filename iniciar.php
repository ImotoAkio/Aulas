    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="inserir_notas.php" class="btn btn-success btn-custom mb-3">Inserir Notas</a>
                <a href="inserir_plano.php" class="btn btn-primary btn-custom">Inserir Plano de Aula</a>
            </div>
        </div>
    </div>
