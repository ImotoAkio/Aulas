...
try {
    ...
    echo "<p><a href='secretaria/cad/professor.php' class='btn btn-primary'>Ir para Cadastro de Professores</a></p>";

} catch (PDOException $e) {
    echo "<p style='color: red;'>✗ Erro ao verificar/atualizar tabela: " . $e->getMessage() . "</p>";
}
?>
