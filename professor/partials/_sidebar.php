      ...
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          ...
          <div class="nav-profile-text d-flex flex-column">
            <span class="font-weight-bold mb-2"><?= htmlspecialchars($_SESSION['usuario_nome'] ?? 'Usuário') ?></span> <!-- AQUI ESTÁ A ALTERAÇÃO -->
            <span class="text-secondary text-small">Professor</span> <!-- Opcional: exibir o tipo de usuário -->
          </div>
