<div class="container-fluid page-body-wrapper">
  ...
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../financeiro/index.php">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="pagamentos">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="../financeiro/pagamentos.php">Listar/Filtrar</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../financeiro/mensalidades.php">Gerar Mensalidades</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../financeiro/listar_mensalidades.php">Listar Mensalidades</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="alunos">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="../financeiro/alunos.php">Lista</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../financeiro/pre_cadastro/index.php">
