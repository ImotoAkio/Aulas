...
if ($aluno_id <= 0) {
    redirectTo('financeiro/alunos.php');
}
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo getPageUrl('financeiro/alunos.php'); ?>">Cadastros</a></li>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <a href="<?php echo getPageUrl('financeiro/alunos.php'); ?>" class="btn btn-gradient-secondary">
                                <i class="mdi mdi-arrow-left"></i> Voltar
                            </a>
                            <a href="<?php echo getPageUrl('financeiro/cad/editar_aluno.php?id=' . $aluno_id); ?>" class="btn btn-gradient-primary">
